    ...
    <div className="bg-[#050505] text-white min-h-screen overflow-x-hidden scroll-smooth">
      ...
      <nav className="w-full border-b border-[#1f1f1f] bg-black/90 backdrop-blur sticky top-0 z-50">
        ...
        {mobileMenuOpen && (
          ...
          <div className="md:hidden border-t border-[#222] bg-black px-6 py-6 flex flex-col gap-6 text-lg uppercase tracking-wide">
      ...
      <section
        id="reviews"
        className="bg-[#0b0b0b] border-y border-[#1f1f1f]"
      >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#111] border border-[#222] rounded-3xl p-8">
              ...
              <p className="text-gray-300 leading-8 mb-6">
                “Best hot sauce I’ve had in years.
            ...
            <div className="bg-[#111] border border-[#222] rounded-3xl p-8">
              ...
              <p className="text-gray-300 leading-8 mb-6">
                “I came for the roti and left with
            ...
            <div className="bg-[#111] border border-[#222] rounded-3xl p-8">
              ...
              <p className="text-gray-300 leading-8 mb-6">
                “Real Caribbean flavour.
                Serious heat. Completely addictive.”
              </p>
